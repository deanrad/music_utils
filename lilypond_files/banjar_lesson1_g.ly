...
\markup {  \larger "Your First Chords - 4 ways to play 'em" \hspace #0 }
\new Score {
<<
...
\markup \smaller \wordwrap {
  Try this little tune below. Its chords are used as the basis of countless other tunes. 
  Once you can play it through once in one of the groups (for example, the set of G C and D that hover around the 5th fret),
  try substituting a chord from another group - for example - play a fretted D one time through and the open D another time.
  Go on ! What have you got to lose !
}
\markup \hspace #0
\markup \larger "Pachelbel's Canon in G"
\markup \hspace #0
\score {
  \new ChordNames \with {
  ...
  \chordmode {     
    \bar "|"
	  g2 g2   d2 d2    c2 c2   g2 g2  \break
	  c2 c2   g2 g2    c2 c2   d2 d2  \bar ":|"
  }
}
