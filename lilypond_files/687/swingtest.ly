...
\score {
  <<
    ...
    \new Staff \with {
      ...
      \repeat unfold 4 { \times 2/3 { c'4 c'8 } }
      \repeat unfold 4 { \times 4/5 { c'8. c'8 } }
      \repeat unfold 8 { \times 2/3 { c'8 c'16 } }
      \repeat unfold 2 { c'4. c'8 }
      \repeat unfold 4 { \times 4/5 { c'16. c'16 c' c'16. } }
      r8 \times 8/7 { c'32. c'16}
         \repeat unfold 3 { \times 8/7 { c'16 c'32. c' c'16 } }
    }
  >>
...
\score {
  <<
    ...
    \new Staff \with {
      ...
      \repeat unfold 7 { \repeat unfold 4 { \times 2/3 { c''8 c'' c'' } }}
    }
  >>
